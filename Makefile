_DEPSH := bitmaps.h config.h config_screen.h gfx.h net.h parser.h test.h types.h utils.h
_DEPSC := bitmaps.c config.c config_screen.c fetch.c gfx.c main.c net.c net_mock.c parser.c utils.c
