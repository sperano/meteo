...
void assert_clone_config(MeteoConfig *cfg1, MeteoConfig *cfg2) {
    ...
    assert(cfg2->cities[0]->name != cfg1->cities[0]->name); // not the same pointer
    assert(strcmp(cfg2->cities[0]->name, "foo1") == 0);
    ...
    assert(cfg2->cities[1]->name != cfg1->cities[1]->name); // not the same pointer
    assert(strcmp(cfg2->cities[1]->name, "foo2") == 0);
...
void test_clone_config(void) {
    ...
    cfg1->cities[0] = safe_malloc(sizeof(CityWeather));
    strcpy(cfg1->cities[0]->id, "12345");
    cfg1->cities[0]->name = "foo1" ;
    ...
    cfg1->cities[1] = safe_malloc(sizeof(CityWeather));
    strcpy(cfg1->cities[1]->id, "67890");
    cfg1->cities[1]->name = "foo2" ;
